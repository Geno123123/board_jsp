    ...
    <div class="col-lg-4">
      <div class="p-5 bg-light rounded-3 shadow">
        <form method="post" action="joinAction.jsp">
          <h3 class="text-center mb-4">회원가입 화면</h3>
          ...
          <div class="mb-3 text-center">
            <input type="radio" class="btn-check" name="userGender" id="male" value="남자" checked>
            <label class="btn btn-outline-primary" for="male">남자</label>

            <input type="radio" class="btn-check" name="userGender" id="female" value="여자">
